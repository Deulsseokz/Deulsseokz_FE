...
export default function MyMissionBox({
  ...
  const conquestRate = Math.round((successCount / totalCount) * 100);
      ...
      <View>
        <View style={styles.rowBox}>
          ...
          <View style={styles.textWrapper}>
            <Text style={styles.pointColor}>{successCount}</Text>
            <Text style={styles.general}>/ {totalCount}</Text>
          </View>
        </View>
        <View style={styles.rowBox}>
          <Text style={styles.text}>정복률</Text>
          <View style={styles.textWrapper}>
            <Text style={styles.pointColor}>{conquestRate}</Text>
