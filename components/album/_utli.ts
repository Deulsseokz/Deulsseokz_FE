...
export const frameImageMap: Record<FrameType, ImageSourcePropType> = {
  ...
  [FrameType.CHRISTMAS]: require('@/assets/images/album/frames/black.png'),
  [FrameType.TREE]: require('@/assets/images/album/frames/rainbow.png'),
  [FrameType.RIBBON]: require('@/assets/images/album/frames/handwriting.png'),
  [FrameType.LINE]: require('@/assets/images/album/frames/shape.png'),
